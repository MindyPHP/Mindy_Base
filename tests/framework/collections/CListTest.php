...
class CListTest extends CTestCase
{
    ...
    {
        $list = new BaseList(array(1, 2, 3), true);
        $this->setExpectedException('\Mindy\Base\Exception\Exception');
        $list->removeAt(2);
    }
    ...
    {
        $list = new BaseList(array('value1', 'value2'));
