...
class MessageCommandTest extends CTestCase
{
    ...
    {
        $this->sourcePath = Alias::get('application.runtime.test_source');
        $this->createDir($this->sourcePath);
        $this->messagePath = Alias::get('application.runtime.test_messages');
        $this->createDir($this->messagePath);
        $this->configFileName = Alias::get('application.runtime') . DIRECTORY_SEPARATOR . 'message_command_test_config.php';
    }
    ...
    protected function createMessageCommand()
    {
        ...
        $command = $this->getMock('\Mindy\Base\MessageCommand', array('usageError'), array('message', null));
        $command->expects($this->any())->method('usageError')->will($this->throwException(new Mindy\Base\Exception\Exception('usageError')));
        return $command;
    }
    ...
    {
        $this->setExpectedException('\Mindy\Base\Exception\Exception', 'usageError');
    ...
    public function testCreateTranslation()
    {
        ...
        $sourceFileContent = "Mindy::t('{$category}','{$message}')";
    ...
    public function testMerge()
    {
        ...
        $sourceFileContent = "Mindy::t('{$category}','{$existingMessage}')";
        $sourceFileContent .= "Mindy::t('{$category}','{$newMessage}')";
        $this->createSourceFile($sourceFileContent);
    ...
    public function testNoLongerNeedTranslation()
    {
        ...
        $sourceFileContent = "Mindy::t('{$category}','some new message')";
        $this->createSourceFile($sourceFileContent);
    ...
    public function testMergeWithContentZero()
    {
        ...
        $newMessage = 'test new message';
        $sourceFileContent = "Mindy::t('{$category}','{$zeroMessage}')";
        $sourceFileContent .= "Mindy::t('{$category}','{$falseMessage}')";
        $sourceFileContent .= "Mindy::t('{$category}','{$newMessage}')";
        $this->createSourceFile($sourceFileContent);
