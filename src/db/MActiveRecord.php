...
class MActiveRecord extends CActiveRecord
{
    ...
    public function paginate($pageSize = null)
    {
        ...
        return array(self::model()->findAll($criteria), $pages);
    }

    public static function model($className = null)
    {
        return parent::model($className === null ? get_called_class() : $className);
    }
    ...
    public function tableName()
    {
        ...
        return isset($vars['tableName']) ? $vars['tableName'] : parent::tableName();
    }
    ...
    {
        // Detach all behaviors before call destructor
    ...
    public function hasBehavior($name)
    {
        ...
        return isset($behaviors[$name]);
    }

    /**
     * Get name of this model for admin interface, singular, plural
     * example: array('Pages', 'page', 'pages')
     * @return array
     */
    public function adminNames()
    {
        ...
        return array(
            ucfirst($className) . "s",
            "Create " . strtolower($className),
            "Update " . strtolower($className)
        );
    }
    ...
    public function getCreateName()
    {
        ...
        return ($adminNames === array()) ? get_class($this) : $adminNames[1];
    }
    ...
    {
        $adminNames = $this->adminNames();
        return ($adminNames === array()) ? get_class($this) : $adminNames[2];
    }
    ...
    {
        $adminNames = $this->adminNames();
        return ($adminNames === array()) ? get_class($this) : $adminNames[0];
    }

    /**
     * Config for MGridView class
     * @return array
     */
     ...
     */
    public function withRelated($runValidation = true, $data = null, $owner = null)
    {
        if ($owner === null)
            $owner = $this->getOwner();
    ...
    /**
     * Function for implements in child classes
     * @return string(url)
     */
