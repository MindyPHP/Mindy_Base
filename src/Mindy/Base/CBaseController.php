 ...
 * @since 1.0
 */
abstract class CBaseController extends Component
{
    ...
    public function renderFile($viewFile, $data = null, $return = false)
    {
        ...
        if (($renderer = Mindy::app()->getViewRenderer()) !== null && $renderer->fileExtension === '.' . CFileHelper::getExtension($viewFile))
        ...
        if (count($this->_widgetStack) === $widgetCount)
            ...
            throw new Exception(Mindy::t('yii', '{controller} contains improperly nested widget tags in its view "{view}". A {widget} widget does not have an endWidget() call.',
    ...
    public function endWidget($id = '')
    {
        if (($widget = array_pop($this->_widgetStack)) !== null) {
            ...
            throw new Exception(Mindy::t('yii', '{controller} has an extra endWidget({id}) call in its view.',
