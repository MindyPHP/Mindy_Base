        ...
        foreach ($this->_logs as $log) {
            ...
            if (!strncasecmp($message, 'begin:', 6)) {
                ...
                if (($last = array_pop($stack)) !== null && $last[0] === $token) {
                    ...
                    throw new Exception(Mindy::t('yii', 'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mindy::beginProfile() and Mindy::endProfile() be properly nested.',
                        array('{token}' => $token)));
            }
        }
