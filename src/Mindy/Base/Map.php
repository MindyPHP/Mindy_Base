 ...
 * @property MapIterator $iterator An iterator for traversing the items in the list.
...
class Map extends Component implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    public function add($key, $value)
    {
        if (!$this->_r) {
            ...
            throw new Exception(Mindy::t('yii', 'The map is read only.'));
    }
    ...
    public function copyFrom($data)
    {
        if (is_array($data) || $data instanceof Traversable) {
            ...
            throw new Exception(Mindy::t('yii', 'Map data must be an array or an object implementing Traversable.'));
    }
